...
Write-Host "Frontend URL: https://advancement-nuclear-recommends-oliver.trycloudflare.com" -ForegroundColor Green
Write-Host ""
...
Write-Host "Cloudflare Frontend: https://advancement-nuclear-recommends-oliver.trycloudflare.com" -ForegroundColor White
Write-Host ""
