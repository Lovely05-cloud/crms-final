...
Write-Host "Backend URL: https://volume-formatting-finest-municipal.trycloudflare.com" -ForegroundColor Green
Write-Host ""
...
Write-Host "Cloudflare Backend: https://volume-formatting-finest-municipal.trycloudflare.com" -ForegroundColor White
Write-Host ""
